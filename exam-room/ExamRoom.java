...
public class ExamRoom {
	...
	public ExamRoom(int N) {
		size = N;
		ranges = new TreeSet<>((range1, range2) -> (range1.lower < 0) ? -1
				: ((range2.lower < 0) ? 1 : Integer.compare(range1.lower, range2.lower)));
		lowerToRange = new HashMap<>();
		upperToRange = new HashMap<>();
		scoreToRange = new TreeMap<>((score1, score2) -> (score1.minDistance != score2.minDistance)
