...
public class Solution {
	public int countCharacters(String[] words, String chars) {
		...
		return Arrays.stream(words).filter(word -> isCovered(buildLetterToCount(word), letterToCount))
	...
	static boolean isCovered(Map<Character, Integer> letterToCount1, Map<Character, Integer> letterToCount2) {
