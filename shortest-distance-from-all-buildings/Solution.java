...
public class Solution {
	...
	public int shortestDistance(int[][] grid) {
		...
		return point2totalDistance.values().stream().mapToInt(totalDistance -> totalDistance).min().getAsInt();
	}
	...
	Map<Point, Integer> search(int[][] grid, int x, int y) {
		...
		Map<Point, Integer> point2distance = new HashMap<Point, Integer>();
	...
	Map<Point, Integer> merge(Map<Point, Integer> point2totalDistance, Map<Point, Integer> point2distance) {
		Map<Point, Integer> merged;
		if (point2totalDistance == null) {
			merged = point2distance;
		} else {
			merged = new HashMap<Point, Integer>();
