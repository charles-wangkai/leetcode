...
public class Solution {
	public String[] spellchecker(String[] wordlist, String[] queries) {
		...
		return Arrays.stream(queries).map(query -> match(wordSet, lowerToWord, patternToWord, query))
				.toArray(String[]::new);
	}
	...
	static String match(Set<String> wordSet, Map<String, String> lowerToWord, Map<String, String> patternToWord,
			String query) {
